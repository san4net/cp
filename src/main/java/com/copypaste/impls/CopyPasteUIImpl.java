...
import static com.copypaste.util.StringSupport.isEmpty;
...
public class CopyPasteUIImpl<E> extends CopyPasteUI<E> {
    ...
    private ActionListener listener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            synchronized (sharedChannel) {
                ...
                if (isEmpty(srcLoc) || isEmpty(destLoc)) {
    ...
    public static class CopyPasteUIBuilder{
        private String title;

        public CopyPasteUIBuilder  withTitle(String title){
            this.title = title;
            return this;
        }

        public CopyPasteUI build(){
            return  new CopyPasteUIImpl<>(title).build();
        }
